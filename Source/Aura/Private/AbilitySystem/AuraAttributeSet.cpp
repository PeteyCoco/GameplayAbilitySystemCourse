...
void UAuraAttributeSet::SetEffectProperties(const FGameplayEffectModCallbackData& Data, FEffectProperties& Props) const
{
	...
	// Collect data from the source ability system, if we can
	...
	// Collect data from the target, if we can
...
void UAuraAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	SetEffectProperties(Data, Props); // Easy access to gameplay entities.
	...
	// Incoming damage received (only on server since it's not replicated!)
...
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UAuraAttributeSet, Health, OldHealth); // Necessary boilerplate macro for GAS
}
